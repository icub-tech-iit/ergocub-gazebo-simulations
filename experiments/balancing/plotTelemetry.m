...
joints_to_plot = ["r_hip_pitch" "r_hip_yaw" "r_hip_roll" "r_knee" "r_ankle_pitch" "r_ankle_roll"];
...
%% Read mat files
testfiledir = './telemetry_data_balancing_right';
...
title_prefix = strcat("x",num2str(increase_factor)," stickBot, balance on ", leg, " leg");
figure
